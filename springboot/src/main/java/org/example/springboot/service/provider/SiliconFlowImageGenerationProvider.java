...
public class SiliconFlowImageGenerationProvider implements ImageGenerationProvider {
    ...
    private final ImageGenerationProfileProperties profileProperties;
    ...
    public ImageGenerationResult generate(ImageGenerationRequest request) {
        ...
        try {
            ImageGenerationProfileProperties.ResolvedProfile profile = profileProperties.resolve(
                    request.modelProfile(), request.aspectRatio());
            Map<String, Object> body = new LinkedHashMap<>();
            body.put("model", profile.model());
            body.put("prompt", request.prompt());
            body.put("image_size", profile.imageSize());
            ...
            return new ImageGenerationResult(imageUrl, profile.model(), sanitized);
