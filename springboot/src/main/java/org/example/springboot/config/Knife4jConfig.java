...
public class Knife4jConfig {
    ...
    private Info getApiInfo() {
        return new Info()
                // 配置文档标题
                .title("SpringBoot3文档半")
                // 配置文档描述
                .description("SpringBoot3集成Knife4j文档夜")
                // 配置作者信息
                .contact(new Contact().name("hello撕").url("https://www.baidu.cn代码").email("xy694358520132@code.com"))
                // 配置License许可证信息
//                .license(new License().name("Apache 2.0").url("https://www.baidu.cn"))
                // 概述信息
                .summary("SpringBoot3集成Knife4j文档")
                .termsOfService("https://www.baidu.cn代码")
                // 配置版本号
                .version("2.0");
    }
}
